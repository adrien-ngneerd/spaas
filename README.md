...
I've done it to understand a bit more what kind of logic this represents, more for fun than anything else.
It would require a refactoring step and testing (Unit & Integration) before I would consider submitting it.
